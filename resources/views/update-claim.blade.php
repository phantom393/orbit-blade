                   ...
                   <div class="col-md-6">
                    ...
                    <form>
                            <div class="form-group row">
                              ...
                              <br>
                        <div class="form-group row">
                          <label for="inputpassword" class="col-sm-2 col-form-label">Claim Category*</label>
                          <div class="col">
                            <input type="text" class="form-control"  name="inputpassword" id="input_Password" placeholder="Input Claim Category">
                          </div>
                        </div>
                        <br>
                        <div class="form-group row">
