...
<body>
	...
	<!-- END breadcrumb -->
	<!-- BEGIN page-header -->
	    <h1 class="page-header">eClaim | Claim Approval</h1>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex justify-content-start">
                            ...
                            <li class="nav-item">
                                <a href="#default-tab-1" data-bs-toggle="tab" class="nav-link active">Claim</a>   
                            </li>
                            <li class="nav-item">
                                <a href="#default-tab-2" data-bs-toggle="tab" class="nav-link ">Cash Advance</a>  
                            </li>
                            </ul>
                        </div>
                ...
                <div id="filteronoff" style="display: none">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        <div class="tab-pane fade active show" id="default-tab-1">
                            {{-- claim approval --}}
                            <table  id="tableclaimapproval"  class="table table-striped table-bordered align-middle">
                                <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="javascript:;" id="" data-id="" class="dropdown-item"  ><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                            <div class="dropdown-divider"></div>
										...
										{{-- appeal --}}
										<a href="#" data-bs-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="display: none"><i class="fa fa-cogs"></i> Action <i class="fa fa-caret-down" ></i></a>
                                        <div class="dropdown-menu">
                                            <a href="javascript:;" id="" data-id="" class="dropdown-item"  ><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="javascript:;" id="" data-id="" class="dropdown-item" ><i class="fa fa-check" aria-hidden="true"></i> Approve</a>
                        ...
                        <div class="tab-pane fade show" id="default-tab-2">
                            <table  id="tablecashadvance"  class="table table-striped table-bordered align-middle">
                                <thead>
                                    ...
                                    <th  data-orderable="false"></th>	
                                    <th  data-orderable="false">Action</th>
                                    <th class="text-nowrap">Cash <br> Advance ID</th>
                                    <th class="text-nowrap">Employee Name</th>
                                    <th class="text-nowrap">Type of <br> Cash Advance</th>
                                    <th class="text-nowrap">Request Date</th>
                                    <th class="text-nowrap">Travel <br> Date</th>
                                    <th class="text-nowrap"> Amount</th>
                                    <th class="text-nowrap">Status</th>
                                    <th class="text-nowrap">Status <br> Date</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <td><input type="checkbox" id="" name="" value=""></td>
